...
public class Reservation_entite {
    ...
    public Reservation_entite(int id_reservation, int user, int ev, LocalDate date, int nbr_place) {
        this.id_reservation = id_reservation;
        this.user = user;
        this.ev = ev;
        this.date = date;
    ...
    public Reservation_entite(int user, int ev, LocalDate date, int nbr_place) {
        this.user = user;
        this.ev = ev;
        this.date = date;
        this.nbr_place = nbr_place;
